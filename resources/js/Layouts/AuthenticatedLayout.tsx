                        ...
                        {role === 'risk-management' ? (
                            <>
                                ...
                                <SidebarLink
                                    ...
                                    active={route().current('risk.index')}
                                >
                                    <div className="flex items-center space-x-3">
                                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <>
                                ...
                                <SidebarLink
                                    ...
                                    active={route().current('gallery-categories.*')}
                                >
                                    <div className="flex items-center space-x-3 pl-8">
                                        ...
                                        <span className="text-sm">Gallery Categories</span>
                                    </div>
                                </SidebarLink>
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        >
                                            <path
                                                ...
                                                strokeLinejoin="round"
                                                strokeWidth="2"
                                                d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"
                                            />
                                        </svg>
                                ...
                                {role === 'admin' && (
                                    <>
                                        ...
                                        <SidebarLink
                                            ...
                                            active={route().current('admin.designations.*')}
                                        >
                                            <div className="flex items-center space-x-3">
                                                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
