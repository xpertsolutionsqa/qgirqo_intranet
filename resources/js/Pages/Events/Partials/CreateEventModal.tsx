...
export default function CreateEventModal({ show, onClose }: Props) {
    const { data, setData, post, processing, errors, reset, clearErrors } =
        useForm({
            ...
            category_id: 1, // Assume 1 is a default category
        });
        ...
        <Modal show={show} onClose={handleClose}>
            <div className="p-6">
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Create a new upcoming event for the company.
                </p>
                ...
                <form className="mt-6 space-y-4" onSubmit={submit}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <InputLabel htmlFor="event_time" value="Time" />
                            <TextInput
                                id="event_time"
                                type="time"
                                className="mt-1 block w-full"
                    ...
                    <div>
                        <InputLabel htmlFor="event_venue" value="Venue" />
                        <TextInput
                            id="event_venue"
                            type="text"
                            className="mt-1 block w-full"
                    ...
                    <div>
                        <InputLabel htmlFor="image" value="Event Banner" />
                        <input
                            id="image"
                            type="file"
